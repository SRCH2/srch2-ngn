 ...
 * <br><br>
 * When the method call {@link Indexable#delete(String)}
 * is made, the {@link SRCH2Engine} will forward the delete request to the SRCH2 search server;
 ...
 * information through the {@link StateResponseListener} callback method
 * {@link StateResponseListener#onDeleteRequestComplete(String, DeleteResponse)} where the
