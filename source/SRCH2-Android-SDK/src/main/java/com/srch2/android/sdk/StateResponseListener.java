 ...
 * {@link SRCH2Engine#setStateResponseListener(StateResponseListener)}.
 * <br><br>
...
public interface StateResponseListener {
     ...
     * when either {@link Indexable#update(org.json.JSONArray)} or
     * {@link Indexable#update(org.json.JSONObject)} is called.
    ...
    */
     ...
     * when {@link Indexable#delete(String)} is called.
     ...
     * when {@link Indexable#getRecordbyID(String)} is called.
