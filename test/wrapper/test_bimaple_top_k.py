...
# File: test_bimaple_top_k_pagination.py
# Author: contact@bimaple.com
# Retrieves JSON response using
# Bimaple-base-search-url for a given query.
# 
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 4:
        ...
        print "Usage:"
        print "python test_bimaple_top_k.py test+obam 10 20"
        print "python test_bimaple_top_k.py ${query} ${topk_A} ${topk_B}"
        return
        

    base_url = base + "/bimaple/search?fuzzy=1&type=0&start=0&q="+query
