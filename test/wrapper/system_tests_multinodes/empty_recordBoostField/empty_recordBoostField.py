...
def testEmptyRecordBoostField(queriesAndResultsPath, binary_path):
    ...
    args = [ binary_path, './empty_recordBoostField/conf-1.xml','./empty_recordBoostField/conf-2.xml','./empty_recordBoostField/conf-3.xml' ]
    ...
    #Load initial data
    dataFile = './empty_recordBoostField/data.json'
