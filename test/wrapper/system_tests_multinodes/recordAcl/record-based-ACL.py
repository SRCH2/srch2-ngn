...
def startCluster(binary_path):
    ...
    args = [ binary_path, './recordAcl/conf-acl-1.xml', './recordAcl/conf-acl-2.xml', './recordAcl/conf-acl-3.xml' ]
...
if __name__ == '__main__':   
    ...
    if(os.path.exists("./recordAcl/core1Data")):
        shutil.rmtree("./recordAcl/core1Data")
    if(os.path.exists("./recordAcl/core2Data")):
        shutil.rmtree("./recordAcl/core2Data")
    if(os.path.exists("./recordAcl/core3Data")):
        shutil.rmtree("./recordAcl/core3Data")
    if(os.path.exists("./recordAcl/core4Data")):
        shutil.rmtree("./recordAcl/core4Data")
    ...
    time.sleep(40)
    # load data
    loadInitialData("core1", currDir + "/recordAcl/core1/movie-data.json")
    loadInitialData("core2", currDir + "/recordAcl/core2/stackoverflow-data-100.json")
    loadInitialData("core3", currDir + "/recordAcl/core3/business-directory-data.json")
    loadInitialData("core4", currDir + "/recordAcl/core4/movie-data.json")
    time.sleep(10)

    loadAcl("core1", currDir + "/recordAcl/core1/acl-data1.json")
    loadAcl("core3", currDir + "/recordAcl/core3/acl-data3.json")
    time.sleep(10)
