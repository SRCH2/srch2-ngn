...
def testPhraseSearch(queriesAndResultsPath, binary_path):
    ...
    args = [ binary_path, './positionalRanking_phraseSearch/conf-1.xml', './positionalRanking_phraseSearch/conf-2.xml', './positionalRanking_phraseSearch/conf-3.xml' ]
    ...
    #Load initial data
    dataFile = './positionalRanking_phraseSearch/data.json'
