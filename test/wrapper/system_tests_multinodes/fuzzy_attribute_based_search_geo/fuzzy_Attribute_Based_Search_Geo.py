#using python fuzzy_Attribute_Based_Search_Geo.py queriesAndResults.txt
...
def testFuzzyAttributeBasedSearchGeo(queriesAndResultsPath, binary_path):
    ...
    args = [ binary_path, './fuzzy_attribute_based_search_geo/conf-1.xml', './fuzzy_attribute_based_search_geo/conf-2.xml', './fuzzy_attribute_based_search_geo/conf-3.xml']
    ...
    #Load initial data
    dataFile = './fuzzy_attribute_based_search_geo/data.json'
...
if __name__ == '__main__':   
    ...
    exitCode = testFuzzyAttributeBasedSearchGeo(queriesAndResultsPath, binary_path)
    os._exit(exitCode)
