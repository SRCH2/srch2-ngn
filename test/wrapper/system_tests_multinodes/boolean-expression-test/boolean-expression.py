...
def testBooleanExpression(queriesAndResultsPath, binary_path):
    ...
    args = [ binary_path, './boolean-expression-test/conf-1.xml', './boolean-expression-test/conf-2.xml', './boolean-expression-test/conf-3.xml' ]
    ...
    #Load initial data
    dataFile = './boolean-expression-test/data.json'
