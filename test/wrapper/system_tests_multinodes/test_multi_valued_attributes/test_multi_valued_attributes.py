...
def testMultiValuedAttributes(f_in , f_facet, binary_path):
    ...
    args = [ binary_path, './test_multi_valued_attributes/conf-1.xml', './test_multi_valued_attributes/conf-2.xml', './test_multi_valued_attributes/conf-3.xml' ]
    ...
    #Load initial data
    dataFile = './test_multi_valued_attributes/newData.json'
