...
#This test case checks if the engine runs using multicore configuration after the logging module is moved out of the core and made global in cofig file
#using: python ./test_logging/loggingInMulticore.py ../../../build/src/server/srch2-search-server ./test_logging/queriesAndResults.txt ./test_logging/queriesAndResults2.txt
...
def testMultipleCores(queriesAndResultsPath, queriesAndResultsPath2, binary_path):
    ...
    args = [ binary_path, '--config-file=./test_logging/conf-multicore.xml' ]
...
if __name__ == '__main__':      
    if(os.path.exists("./test_logging/core1Data")):
        shutil.rmtree("./test_logging/core1Data")
    if(os.path.exists("./test_logging/core2Data")):
        shutil.rmtree("./test_logging/core2Data")
    if(os.path.exists("./test_logging/core3Data")):
        shutil.rmtree("./test_logging/core3Data")
    if(os.path.exists("./test_logging/core4Data")):
        shutil.rmtree("./test_logging/core4Data")
    if(os.path.exists("./test_logging/coreGeoData")):
        shutil.rmtree("./test_logging/coreGeoData")
