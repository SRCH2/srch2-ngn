...
#Test 1: test loading index from the sqlite table to create the index, engine exits gracefully.
...
#Test 3: During the engine is down, delete the records in sqlite.
