...
#Test 3: Shut down the engine, and delete the records in oracle.
...
#Test 1: test loading index from the oracle table to create the index.
def testCreateIndexes(conn,sqlQueriesPath,testQueriesPath):
    ...
    #the engine will create an index from the oracle table
    startSrch2Engine()
    time.sleep(5)
