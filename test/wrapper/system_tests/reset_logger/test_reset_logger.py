...
if __name__ == '__main__':
    ...
    try:
        ...
        print "Exception checking size of old, renamed logfile " + str(logFileName) + '.1  - Logrotate probably did not rotate it because its already been rotated recently.  Force it.'
