...
void test1(){
	...
	// RandomAccessVerificationAnd Operator
	PhysicalOperatorFactory operatorFactory;
	RandomAccessVerificationAndOperator * verificationOp = operatorFactory.createRandomAccessVerificationAndOperator();
	RandomAccessVerificationAndOptimizationOperator * verificationOpOp = operatorFactory.createRandomAccessVerificationAndOptimizationOperator();
...
int main(int argc, char *argv[]) {
	...
	test2();
	test3();
	cout << "RandomAccessVerificationAnd_Test: Passed\n" << endl;
}
