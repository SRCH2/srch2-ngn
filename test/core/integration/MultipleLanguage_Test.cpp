...
void testSimpleChinese() {
	...
	//Query: "孔子", hits -> 1101, 1108， 1201
	{
		...
		ASSERT(
				pingExactPrefix(analyzer, queryEvaluator, "孔子", 3, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
				pingFuzzyPrefix(analyzer, queryEvaluator, "孔子", 3, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
				pingExactComplete(analyzer, queryEvaluator, "孔子", 3, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
				pingFuzzyComplete(analyzer, queryEvaluator, "孔子", 3, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
	}
	...
	//Query: "长江", hits -> 1102, 1104
	{
		...
		ASSERT(
				pingExactPrefix(analyzer, queryEvaluator, "长江", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
				pingFuzzyPrefix(analyzer, queryEvaluator, "长江", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
				pingExactComplete(analyzer, queryEvaluator, "长江", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
				pingFuzzyComplete(analyzer, queryEvaluator, "长江", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
	}
	...
	//Query: "Mr", hits -> 1003, 1201
	{
		...
		recordIds.push_back(1201);
		ASSERT(
				pingExactPrefix(analyzer, queryEvaluator, "Mr", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
				pingFuzzyPrefix(analyzer, queryEvaluator, "Mr", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
				pingExactComplete(analyzer, queryEvaluator, "Mr", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
				pingFuzzyComplete(analyzer, queryEvaluator, "Mr", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
	}
	...
	//Query: "Miss 李清照", hits -> 1003, 1201
	{
		...
		ASSERT(
				pingExactPrefix(analyzer, queryEvaluator,
						"Miss 李清照 生当作people杰，死亦为ghost雄。", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
	...
	//Query: "Miss 李清照", hits -> 1202, 1203
	{
		...
		ASSERT(
				pingExactPrefix(analyzer, queryEvaluator,
						"Miss 李清照 生当作peple杰，死亦为ghost雄。", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== false);
		ASSERT(
				pingFuzzyPrefix(analyzer, queryEvaluator,
						"Miss 李清照 生当作peple杰，死亦为ghost雄。", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND) == true);
		ASSERT(
				pingExactComplete(analyzer, queryEvaluator,
						"Miss 李清照 生当作peple杰，死亦为ghost雄。", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== false);
	...
	//Query: "孔子", hits -> 1101, 1108, 1201，1998, 1999
	{
		...
		ASSERT(
				pingExactPrefix(analyzer, queryEvaluator, "孔子", 5, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
				pingFuzzyPrefix(analyzer, queryEvaluator, "孔子", 5, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
				pingExactComplete(analyzer, queryEvaluator, "孔子", 5, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
				pingFuzzyComplete(analyzer, queryEvaluator, "孔子", 5, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
	}
	...
	//Query: "东山", hits -> 1108, 1999
	{
		...
		recordIds.push_back(1999);
		ASSERT(
				pingExactPrefix(analyzer, queryEvaluator, "东山", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
				pingFuzzyPrefix(analyzer, queryEvaluator, "东山", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
				pingExactComplete(analyzer, queryEvaluator, "东山", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
				pingFuzzyComplete(analyzer, queryEvaluator, "东山", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
	}
...
void testSimpleZhuyin() {
	...
	//Query: "ㄎㄨㄥ ㄗ", hits -> 1101,  1108， 1201
	{
		...
		recordIds.push_back(1201);
		ASSERT(
				pingExactPrefix(analyzer, queryEvaluator, "ㄎㄨㄥ ㄗ", 3, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
				pingFuzzyPrefix(analyzer, queryEvaluator, "ㄎㄨㄥ ㄗ", 3, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
	...
	//Query: "ㄔㄤ ㄐㄧㄤ", hits -> 1102, 1104
	{
		...
		recordIds.push_back(1104);
		ASSERT(
				pingExactPrefix(analyzer, queryEvaluator, "ㄔㄤ ㄐㄧㄤ", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
				pingFuzzyPrefix(analyzer, queryEvaluator, "ㄔㄤ ㄐㄧㄤ", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
	...
	//Query: "Miss ㄌㄧ ㄑㄧㄥ ㄓㄠ", hits -> 1003, 1201
	{
		...
		ASSERT(
				pingExactPrefix(analyzer, queryEvaluator,
						...
						2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND) == true);
		ASSERT(
				pingFuzzyPrefix(analyzer, queryEvaluator,
						"Miss ㄌㄧ ㄑㄧㄥ ㄓㄠ ㄕㄥ ㄉㄤ ㄗㄨㄛ people ㄐㄧㄝ ㄙ ㄧ ㄨㄟ ghost ㄒㄩㄥ",
						2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND) == true);
	...
	//Query: "Miss ㄌㄧ ㄑㄧㄥ ㄓㄠ", hits -> 1202, 1203
	{
		...
		ASSERT(
				pingExactPrefix(analyzer, queryEvaluator,
						...
						2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND) == false);
		ASSERT(
				pingFuzzyPrefix(analyzer, queryEvaluator,
						"Miss ㄌㄧ ㄑㄧㄥ ㄓㄠ ㄕㄥ ㄉㄤ ㄗㄨㄛ peple ㄐㄧㄝ ㄙ ㄧ ㄨㄟ ghost ㄒㄩㄥ",
						2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND) == true);
	...
	//Query: "ㄎㄨㄥ ㄗ", hits -> 1101,  1108,  1201, 1999, 1998
	{
		...
		recordIds.push_back(1998);
		ASSERT(
				pingExactPrefix(analyzer, queryEvaluator, "ㄎㄨㄥ ㄗ", 5, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
				pingFuzzyPrefix(analyzer, queryEvaluator, "ㄎㄨㄥ ㄗ", 5, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
	...
	//Query: "ㄉㄨㄥ ㄕㄢ", hits ->  1108,  1999
	{
		...
		recordIds.push_back(1999);
		ASSERT(
				pingExactPrefix(analyzer, queryEvaluator, "ㄉㄨㄥ ㄕㄢ", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
				pingFuzzyPrefix(analyzer, queryEvaluator, "ㄉㄨㄥ ㄕㄢ", 2, recordIds, vector<unsigned>(), ATTRIBUTES_OP_AND)
						== true);
		ASSERT(
