...
//void testShard(){
//
//	ClusterShard* s1 = new ClusterShard(1,1,1,1);
//	ASSERT(s1->getShardId().toString() == "C1_R1_1");
//
//	ClusterShard* s2 = new ClusterShard(2,1,2,1);
//	ASSERT(s2->getShardId().toString() == "C1_R2_1");
//
//	ClusterShard* s3 = new ClusterShard(3,2,2,0);
...
//}
//
//void testDataFilePaths(char * configFile){
//	vector<string> paths;
//	ConfigManager *configManager = new ConfigManager(configFile);
//	configManager->loadConfigFile();
//	CoreInfo_t* c1 = configManager->getCoreByName("core1");
//	c1->getJsonFilePaths(paths);
//	ASSERT(paths[0] == "/home/prateek/./multicore//SRCH2Cluster/core1/abc");
//	ASSERT(paths[1] == "/home/prateek/./multicore//SRCH2Cluster/core1/xyz");
//
//}
//
//int main() {
...
//
//	testDataFilePaths(getenv("ConfigManagerFilePath1"));
//
//}
//
//
