...
python $pythonCode $nodeAddress ./nodeIntensive-noValidation/transaction-1.txt & | tee transactionOutput-1.txt
python $pythonCode $nodeAddress $transaction_run_extraNode &
...
wait
python $pythonCode $nodeAddress $transaction_kill_extraNode &
wait
