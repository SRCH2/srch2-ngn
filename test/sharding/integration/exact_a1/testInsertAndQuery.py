...
# python ./exact_a1/test_insertAndQuery.py ../../../build/src/server/srch2-search-server ./exact_a1/insertFile.txt ./exact_a1/nodesList.txt
...
import os, time, sys, json, subprocess, commands, urllib2, signal
