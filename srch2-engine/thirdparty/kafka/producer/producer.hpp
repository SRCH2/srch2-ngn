...
public:
	...
	producer(boost::asio::io_service& io_service, const std::string& hostname, const uint16_t port, const error_handler_function& error_handler = error_handler_function());
	~producer();
