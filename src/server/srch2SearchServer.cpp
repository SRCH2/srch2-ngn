...
static int getHttpServerMetadata(ConfigManager *config, 
	...
	std::set<short> ports;
	ports.insert(6090); // search
	ports.insert(6091); // suggest
	ports.insert(6092); // info
	ports.insert(6093); // docs
	ports.insert(6094); // update
	ports.insert(6095); // save
	ports.insert(6096); // export
	ports.insert(6097); // reset
