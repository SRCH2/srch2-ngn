...
Json::Value IndexWriteUtil::_insertCommand(Indexer *indexer, const CoreInfo_t *indexDataContainerConf, const Json::Value &root, Record *record)
{
...
Json::Value IndexWriteUtil::_deleteCommand(Indexer *indexer, const CoreInfo_t *indexDataContainerConf, const Json::Value &root)
{
    Json::Value response(Json::objectValue);
...
Json::Value IndexWriteUtil::_deleteCommand_QueryURI(Indexer *indexer, const CoreInfo_t *indexDataContainerConf, const evkeyvalq &headers)
{
    Json::Value response(Json::objectValue);
    //set the primary key of the record we want to delete
    std::string primaryKeyName = indexDataContainerConf->getPrimaryKey();
...
Json::Value IndexWriteUtil::_updateCommand(Indexer *indexer, const CoreInfo_t *indexDataContainerConf, const evkeyvalq &headers, const Json::Value &root, Record *record)
{
    Json::Value response(Json::objectValue);
    ...
    if ( indexer->getNumberOfDocumentsInIndex() < indexDataContainerConf->getDocumentLimit() )
    {
        ...
        switch( ret )
        {
            case srch2::instantsearch::OP_SUCCESS:
                {
                    if (recordExisted){
                        response[c_action_update] = "Existing record updated successfully";
                    } else {
...
Json::Value IndexWriteUtil::_exportCommand(Indexer *indexer, const char* exportedDataFileName)
{
    Json::Value response(Json::objectValue);
...
Json::Value IndexWriteUtil::_commitCommand(Indexer *indexer, const CoreInfo_t *indexDataContainerConf, const uint64_t offset)
{
    Json::Value response(Json::objectValue);
    //commit the index.
