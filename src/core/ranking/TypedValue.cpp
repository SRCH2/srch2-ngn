...
namespace srch2
{
    ...
    void * TypedValue::serializeForNetwork(void * buffer) const{
    	...
    	case ATTRIBUTE_TYPE_INT:
        	...
        	break;
    	case ATTRIBUTE_TYPE_LONG:
        	buffer = srch2::util::serializeFixedTypes(longTypedValue, buffer);
        	break;
    	case ATTRIBUTE_TYPE_FLOAT:
        	buffer = srch2::util::serializeFixedTypes(floatTypedValue, buffer);
        	break;
    	case ATTRIBUTE_TYPE_DOUBLE:
        	buffer = srch2::util::serializeFixedTypes(doubleTypedValue, buffer);
        	break;
    	case ATTRIBUTE_TYPE_TEXT:
    	...
    	case ATTRIBUTE_TYPE_MULTI_INT:
        	...
        	break;
    	case ATTRIBUTE_TYPE_MULTI_LONG:
        	buffer = srch2::util::serializeVectorOfFixedTypes(longTypedMultiValue, buffer);
        	break;
    	case ATTRIBUTE_TYPE_MULTI_FLOAT:
        	buffer = srch2::util::serializeVectorOfFixedTypes(floatTypedMultiValue, buffer);
        	break;
    	case ATTRIBUTE_TYPE_MULTI_DOUBLE:
        	buffer = srch2::util::serializeVectorOfFixedTypes(doubleTypedMultiValue, buffer);
        	break;
    	case ATTRIBUTE_TYPE_MULTI_TEXT:
    ...
    void * TypedValue::deserializeForNetwork(TypedValue &value, void * buffer){
    	...
    	case ATTRIBUTE_TYPE_INT:
        	...
        	break;
    	case ATTRIBUTE_TYPE_LONG:
        	buffer = srch2::util::deserializeFixedTypes(buffer, value.longTypedValue);
        	break;
    	case ATTRIBUTE_TYPE_FLOAT:
        	buffer = srch2::util::deserializeFixedTypes(buffer, value.floatTypedValue);
        	break;
    	case ATTRIBUTE_TYPE_DOUBLE:
        	buffer = srch2::util::deserializeFixedTypes(buffer, value.doubleTypedValue);
        	break;
    	case ATTRIBUTE_TYPE_TEXT:
    	...
    	case ATTRIBUTE_TYPE_MULTI_INT:
        	...
        	break;
    	case ATTRIBUTE_TYPE_MULTI_LONG:
        	buffer = srch2::util::deserializeVectorOfFixedTypes(buffer, value.longTypedMultiValue);
        	break;
    	case ATTRIBUTE_TYPE_MULTI_FLOAT:
        	buffer = srch2::util::deserializeVectorOfFixedTypes(buffer, value.floatTypedMultiValue);
        	break;
    	case ATTRIBUTE_TYPE_MULTI_DOUBLE:
        	buffer = srch2::util::deserializeVectorOfFixedTypes(buffer, value.doubleTypedMultiValue);
        	break;
    	case ATTRIBUTE_TYPE_MULTI_TEXT:
    ...
    unsigned TypedValue::getNumberOfBytesForSerializationForNetwork() const{
    	...
    	case ATTRIBUTE_TYPE_INT:
        	...
        	break;
    	case ATTRIBUTE_TYPE_LONG:
        	numberOfBytes += sizeof(longTypedValue);
        	break;
    	case ATTRIBUTE_TYPE_FLOAT:
        	numberOfBytes += sizeof(floatTypedValue);
        	break;
    	case ATTRIBUTE_TYPE_DOUBLE:
        	numberOfBytes += sizeof(doubleTypedValue);
        	break;
    	case ATTRIBUTE_TYPE_TEXT:
    	...
    	case ATTRIBUTE_TYPE_MULTI_INT:
        	...
        	break;
    	case ATTRIBUTE_TYPE_MULTI_LONG:
        	numberOfBytes += srch2::util::getNumberOfBytesVectorOfFixedTypes(longTypedMultiValue);
        	break;
    	case ATTRIBUTE_TYPE_MULTI_FLOAT:
        	numberOfBytes += srch2::util::getNumberOfBytesVectorOfFixedTypes(floatTypedMultiValue);
        	break;
    	case ATTRIBUTE_TYPE_MULTI_DOUBLE:
        	numberOfBytes += srch2::util::getNumberOfBytesVectorOfFixedTypes(doubleTypedMultiValue);
        	break;
    	case ATTRIBUTE_TYPE_MULTI_TEXT:
