...
void IndexData::_getExportData(vector<std::string> &compressedInMemoryRecordStrings) const
{
    ForwardIndex::getExportData(*this->forwardIndex, compressedInMemoryRecordStrings);
}
