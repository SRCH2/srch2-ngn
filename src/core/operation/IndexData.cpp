...
void IndexData::_exportData(vector<std::string> &compressedInMemoryRecordStrings) const
{
    ForwardIndex::exportData(*this->forwardIndex, compressedInMemoryRecordStrings);
}
