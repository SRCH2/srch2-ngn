...
private:
	...
	void injectSortOperatorsForFeedback(PhysicalPlanOptimizationNode * *node);
	void injectSortOperatorsForFeedback(PhysicalPlanOptimizationNode *node, unsigned childOffset);
