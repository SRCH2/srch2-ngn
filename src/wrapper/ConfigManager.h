...
// configuration file tag and attribute names for ConfigManager
    static const char* const accesslogfileName;
    static const char* const analyzerName;
    static const char* const cachesizeName;
    static const char* const collectionName;
    static const char* const configName;
    static const char* const datadirName;
    static const char* const datafileName;
    static const char* const datasourcetypeName;
    static const char* const dbName;
    static const char* const defaultName;
    static const char* const defaultquerytermboostName;
    static const char* const dictionaryName;
    static const char* const enablepositionindexName;
    static const char* const expandName;
    static const char* const facetenabledName;
    static const char* const facetendName;
    static const char* const facetfieldName;
    static const char* const facetfieldsName;
    static const char* const facetgapName;
    static const char* const facetstartName;
    static const char* const facettypeName;
    static const char* const fieldName;
    static const char* const fieldbasedsearchName;
    static const char* const fieldboostName;
    static const char* const fieldsName;
    static const char* const fieldtypeName;
    static const char* const filterName;
    static const char* const fuzzymatchpenaltyName;
    static const char* const hostName;
    static const char* const indexconfigName;
    static const char* const indexedName;
    static const char* const indextypeName;
    static const char* const licensefileName;
    static const char* const listenerwaittimeName;
    static const char* const listeninghostnameName;
    static const char* const listeningportName;
    static const char* const location_latitudeName;
    static const char* const location_longitudeName;
    static const char* const loglevelName;
    static const char* const maxdocsName;
    static const char* const maxmemoryName;
    static const char* const maxretryonfailureName;
    static const char* const maxsearchthreadsName;
    static const char* const mergeeverymwritesName;
    static const char* const mergeeverynsecondsName;
    static const char* const mergepolicyName;
    static const char* const mongodbName;
    static const char* const nameName;
    static const char* const portName;
    static const char* const PorterStemFilterName;
    static const char* const prefixmatchpenaltyName;
    static const char* const queryName;
    static const char* const queryresponsewriterName;
    static const char* const querytermlengthboostName;
    static const char* const querytermmatchtypeName;
    static const char* const querytermsimilaritythresholdName;
    static const char* const querytermtypeName;
    static const char* const rankingalgorithmName;
    static const char* const recordboostfieldName;
    static const char* const recordscoreexpressionName;
    static const char* const refiningName;
    static const char* const requiredName;
    static const char* const responsecontentName;
    static const char* const responseformatName;
    static const char* const rowsName;
    static const char* const schemaName;
    static const char* const searchableName;
    static const char* const searchertypeName;
    static const char* const srch2homeName;
    static const char* const StopFilterName;
    static const char* const supportswapineditdistanceName;
    static const char* const SynonymFilterName;
    static const char* const synonymsName;
    static const char* const text_enName;
    static const char* const typeName;
    static const char* const typesName;
    static const char* const uniquekeyName;
    static const char* const updatehandlerName;
    static const char* const updatelogName;
    static const char* const wordsName;
};
