//$Id: BimapleServerLogger.cpp 2649 2012-07-04 00:06:38Z oliverax $
...
void BimapleServerLogger::BMLogRaw(const /*uint8_h*/int level, const char *msg) const
{
...
void BimapleServerLogger::BMLog(const int level, const char *fmt, ...) const
{
	va_list ap;
