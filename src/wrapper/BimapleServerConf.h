//$Id: BimapleServerConf.h 3188 2013-02-14 05:32:13Z oliverax $

#ifndef __BIMAPLESERVERCONG_H__
#define __BIMAPLESERVERCONG_H__
...
private:
	...
	vector<bimaple::instantsearch::FilterType> sortableAttributesType; // Float or unsigned
...
public:
	BimapleServerConf(int argc, char** argv, bool &configSuccess, std::stringstream &parseError);
	virtual ~BimapleServerConf();
	...
	const vector<bimaple::instantsearch::FilterType> * getSortableAttributesType() const;
