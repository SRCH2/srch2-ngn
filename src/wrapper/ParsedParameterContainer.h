...
public:
    ...
    TermIntermediateStructure(TermIntermediateStructure * input){
        ...
        for(vector<string>::iterator it = input->fieldFilter.begin();it != input->fieldFilter.end();it++){
        ...
        for(vector<unsigned>::iterator it = input->fieldFilterList.begin();it != input->fieldFilterList.end();it++){
