srch2lib = {
    ...
    /********************************************************/
    //Send query with pre-setted parameters and return the response json to the callback function with name "responseHandlerName"
    ...
    setSearchFields : function(searchFields){
        this.searchFieldsStr = searchFields;
        return this;
    },
    ...
    setFilterQueryParam : function(filterQuery){
        ...
        this.filterQueryStr = "fq=" + filterQuery;
        return this;
    },
    ...
    setFieldList : function(fieldList){ 
        ...
        for(var i = 0 ; i < fieldList.length ; i++){
            if(i == 0){
                this.fieldListStr += "fl=" + fieldList[i];
            }else{
                this.fieldListStr += "," + fieldList[i];
            }
        }
        return this;
    },
    ...
    setFacetFieldList : function(facetFieldList){
        ...
        for(var i = 0; i < facetFieldList.length ; i++){
            if(i == 0){
                this.facetFieldStr += "facet.field=" + facetFieldList[i];
            }else{
                this.facetFieldStr += "&facet.field=" + facetFieldList[i];
            }
        }
    ...
    setFacetCategoryRows : function(category, rows){
        ...
        this.facetCategoryRows = "f." + category + ".rows=" + rows;
        return this;
    },
    ...
    setFacetRange : function(category, start, end, gap){
        ...
        this.facetRangeCategoryStr = "facet.range=" + category;

        if(typeof(start) != undefined && start != ""){
            this.facetRangeStartStr = "f." + category + ".start=" + start;
        } else {
            this.facetRangeStartStr = null;
        }

        if(typeof(end) != undefined && end != ""){
            this.facetRangeEndStr = "f." + category + ".end=" + end;
        } else {
            this.facetRangeEndStr = null;
        }
        ...
        if(typeof(gap) != undefined && gap != ""){
            this.facetRangeGapStr = "f." + category + ".gap=" + gap;
        } else {
            this.facetRangeGapStr= null;
        }
        return this;
    ...
    setSortList : function(categoryList){
        ...
        for(var i = 0 ; i < categoryList.length ; i++){
            if(i == 0){
                this.sortStr += "sort=" + categoryList[i];
            }else{
                this.sortStr += "," + categoryList[i];
            }
        }
        return this;
    },
