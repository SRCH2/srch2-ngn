//$Id: Analyzer.h 3419 2013-06-06 12:43:09Z jiaying $
...
typedef enum
{
    ...
    SIMPLE_ANALYZER = 1       // SimpleAnalyzer
} AnalyzerType ;
...
public:
     ...
     */
    virtual void tokenizeQuery(const std::string &queryString, std::vector<std::string> &queryKeywords) const = 0;
    ...
    virtual void tokenizeQueryWithFilter(const std::string &queryString, std::vector<std::string> &queryKeywords,
