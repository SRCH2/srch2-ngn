...
#define MONGOCLIENT_VERSION_MAJOR 0
#define MONGOCLIENT_VERSION_MINOR 11
...
namespace client {
    ...
    const char kVersionString[] = "0.11.0-pre";
    ...
    const char kGitRevision[] = "b2664a57eb7ab0e5ca4af0b06504337b1e061b19";
